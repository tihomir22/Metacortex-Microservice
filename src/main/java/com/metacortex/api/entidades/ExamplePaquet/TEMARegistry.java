...
@ApiModel(description="Triple Exponencial Moving Average Single Registry")

public class TEMARegistry {

        @ApiModelProperty(notes="Number of the record , similar to id",example = "351")
        private int numRegistry;
        @ApiModelProperty(notes="Extra information about the registry", example = "TEMA Registry #351")
        private String extra;
        @ApiModelProperty(notes="Historic price attached to the technical indicator registry below",example = "11617.91")
        private double historicPrice;
        @ApiModelProperty(notes="Technical indicator registry",example = "10478.87053")
        private double technicalIndicator;
        @ApiModelProperty(notes="Date of the technical registry ", example = "1563700393")
        private Date date;


    public TEMARegistry(TechnicalRegistry techny) {
