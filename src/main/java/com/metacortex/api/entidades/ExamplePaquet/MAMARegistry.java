...
@ApiModel(description="Mesa Adaptive Moving Average Single Registry")

public class MAMARegistry {

        @ApiModelProperty(notes="Number of the record , similar to id",example = "251")
        private int numRegistry;
        @ApiModelProperty(notes="Extra information about the registry", example = "MAMA Registry #251")
        private String extra;
        @ApiModelProperty(notes="Historic price attached to the technical indicator registry below",example = "10617.91")
        private double historicPrice;
        @ApiModelProperty(notes="Technical indicator registry",example = "10778.870510444653")
        private double technicalIndicator;
        @ApiModelProperty(notes="Date of the technical registry ", example = "1563700393")
        private Date date;


    public MAMARegistry(TechnicalRegistry techny) {
